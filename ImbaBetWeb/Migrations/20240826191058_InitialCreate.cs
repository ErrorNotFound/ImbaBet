        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasGroupRanking = table.Column<bool>(type: "bit", nullable: false),
                    StackRank = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FlagCountryCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StackRank = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamATeamId = table.Column<int>(type: "int", nullable: true),
                    TeamBTeamId = table.Column<int>(type: "int", nullable: true),
                    AlternativeTeamAText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AlternativeTeamBText = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MemberOfCommunityId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MemberOfCommunityId",
                table: "AspNetUsers",
                column: "MemberOfCommunityId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Communities_MemberOfCommunityId",
                table: "AspNetUsers",
                column: "MemberOfCommunityId",
